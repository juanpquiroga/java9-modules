package academy.programming.jokeserver.programmer;

import academy.learnprogramming.jokeserver.JokeServer;
import academy.programming.jokeserver.programmer.internal.Filter;
...
public class ProgrammerJokeServer implements JokeServer {
    ...
    private static int getRandomInteger(int maximum, int minimum){
        Logger.getLogger(ProgrammerJokeServer.class.getName()).log(Level.INFO,"Calculando");
